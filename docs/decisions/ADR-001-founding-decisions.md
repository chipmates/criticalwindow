...
| 3   | Takeaways              | Five fixed pillars, to be tested by pre/post surveys once the alpha survey exists                          | If we cannot say what players should feel, we cannot design mechanics that make them feel it |
