...
Status: **DRAFT — proposed 2026-07-04, awaiting sign-off.** Not in effect until accepted.
...
- [ ] Project lead accepts (converts this ADR from DRAFT to accepted, dates it, and this becomes
      the governing decision; ADR-001 #8/#18 read as amended above).
