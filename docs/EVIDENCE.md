...
| alignmentModel.safetyDriftDivisor | value 4 | design choice | SRC-DESIGN-HANDOVER | safety points -> true-alignment gain divisor. Raised from an implicit 2 on 2026-07-04 (playtest finding: random play always flourished). Alignment is slow, expensive, and must be sustained. |
