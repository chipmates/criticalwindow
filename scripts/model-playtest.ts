...
function llmPolicy(): Policy {
  ...
  const RULES = [
    ...
    'treaty (channel open, bilateral trust 800+, turn 11+, BOTH seats have played',
    ...
    'signal, then co-sign at trust 800+ after turn 11 to SIGN). natsec_merge: 150pc, needs capability 500 + mid era -> compute +150,',
