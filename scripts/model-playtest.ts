...
function llmPolicy(): Policy {
  ...
  const RULES = [
    ...
    'signal, then co-sign at trust 850+ after turn 11 while BOTH sides hold 300+ political capital to SIGN). natsec_merge: 150pc, needs capability 500 + mid era -> compute +150,',
